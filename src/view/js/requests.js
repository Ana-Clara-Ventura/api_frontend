...
function cadastrar() {
    ...
    const dados = {
        nome: document.querySelector('[name="input-nome"]').value,
        cpf: document.querySelector('[name="input-cpf"]').value,
        data_nascimento: document.querySelector('[name="input-nascimento"]').value,
        telefone: document.querySelector('[name="input-telefone"]').value,
        endereco: document.querySelector('[name="input-endereco"]').value,
        altura: document.querySelector('[name="input-altura"]').value,
        peso: document.querySelector('[name="input-peso"]').value
    }
